...
public class UsersWebServerImpl implements UsersWebServer {
    ...
    public UsersWebServerImpl(int port, Gson gson, TemplateProcessor templateProcessor, UserAuthService authService, DBServiceClient dbServiceClient) {
        this.gson = gson;
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new ClientServlet(templateProcessor, dbServiceClient)), "/users");
